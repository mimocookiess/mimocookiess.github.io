...
add constraint orders_ga_client_id_check
check (
  ga_client_id is null
  or ga_client_id ~ '^[A-Za-z0-9._-]{1,128}$'
),
add constraint orders_ga_session_id_check
check (
  ga_session_id is null
  or ga_session_id ~ '^[0-9]{1,32}$'
);
